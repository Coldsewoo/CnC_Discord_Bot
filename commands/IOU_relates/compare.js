...
Always Online   -  ${gBuilding["AO"]["ShipArenaDmg"]}\`\`\``,
                                                        ...
                                                        if (content[0] === 'highest') {
                                                            var petHigh = gBuilding["others"]["petArenaHighest"].split(",");
                                                            var ascHigh = gBuilding["others"]["ascPointsHighest"].split(",");
                                                            var shipHigh = gBuilding["others"]["shipArenaHighest"].split(",");
                                                            var woodHigh = gBuilding["others"]["woodCuttingHighest"].split(",");
                                                            var stoneHigh = gBuilding["others"]["stoneHighest"].split(",");
                                                            var soHigh = gBuilding["others"]["SacEXPHighest"].split(",");
                                                            message.channel.send({
                                                                embed: {
                                                                    color: `${color}`,
                                                                    author: {
